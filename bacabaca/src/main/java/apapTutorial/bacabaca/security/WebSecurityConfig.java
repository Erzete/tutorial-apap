package apapTutorial.bacabaca.security;
...
import apapTutorial.bacabaca.security.jwt.JwtTokenFilter;
    ...
    public SecurityFilterChain webFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf(Customizer.withDefaults())
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/buku/update")).hasAuthority("Pustakawan")
                        .anyRequest().authenticated()
                )
                .formLogin((form) -> form
                        .loginPage("/login")
